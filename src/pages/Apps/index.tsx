      ...
      <Section className="bg-white border-t border-warm-sage py-16 lg:py-20">
        <Container>
          <motion.div 
            ...
            variants={fadeUp}
            className="mx-auto max-w-4xl text-center mb-12 lg:mb-16"
          >
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <motion.div 
              ...
              viewport={{ once: true, margin: "-100px" }}
              variants={fadeUp}
              className="mt-20 pt-16 border-t border-warm-sage text-center"
            >
            ...
            {categories.map((category, index) => {
              ...
              return (
                ...
                >
                  ...
                  <motion.div variants={isEven ? slideInLeft : slideInRight} className={`lg:w-1/2 ${isEven ? 'lg:pr-12' : 'lg:order-last lg:pl-12'}`}>
          ...
          <div className="space-y-20 max-w-7xl mx-auto">
            {workflows.map((workflow, idx) => (
              <motion.div 
                ...
                viewport={{ once: true, margin: "-100px" }}
                variants={fadeUp}
                className="bg-white border border-warm-sage rounded-xl p-10 lg:p-16 shadow-sm hover:shadow-md transition-shadow flex flex-col lg:flex-row gap-12 items-center"
              >
