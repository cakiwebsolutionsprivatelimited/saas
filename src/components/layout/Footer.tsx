...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-zinc-200 bg-white pt-24 pb-12">
      <Container>
        
        {/* Mini CTA Area */}
        <div className="mb-24 flex flex-col items-center justify-between gap-8 rounded-[2rem] bg-zinc-50 ring-1 ring-zinc-200 px-8 py-12 text-center md:flex-row md:px-16 md:py-16 md:text-left shadow-sm overflow-hidden relative">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-5 lg:gap-8">
          ...
          <div>
            <h3 className="mb-6 text-sm font-bold tracking-wider text-zinc-900 uppercase">
              Product
            </h3>
            <ul className="space-y-4">
              {platformNav.map((item) => (
                <li key={item.path}>
                  <Link
                    to={item.path}
                    className="text-base font-medium text-zinc-600 transition-colors hover:text-indigo-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600 focus-visible:ring-offset-2 rounded-md"
                  >
                    {item.name}
                  </Link>
                </li>
        ...
        <div className="mt-20 flex flex-col items-center justify-between border-t border-zinc-200 pt-8 sm:flex-row gap-4">
